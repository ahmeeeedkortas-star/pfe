...
const CST_ICONS = [
  { id: 'cst-tb', ic: '⊞', lb: 'Tableau de bord SMI', bg: '#f0f0fa', c: '#000080' },
  { id: 'cst-swot', ic: '⬡', lb: 'Analyse SWOT', bg: '#f0f0fa', c: '#000080' },
  ...
  { id: 'cst-objectifs', ic: '🎯', lb: 'Objectifs stratégiques', bg: '#f0f0fa', c: '#000080' },
  { id: 'cst-changements', ic: '↺', lb: 'Gestion changements', bg: '#FFFBEB', c: '#92400E' },
  { id: 'cst-revue', ic: '📋', lb: 'Revue de direction', bg: '#EDE9FE', c: '#6D28D9' },
  { id: 'cst-politique', ic: '📜', lb: 'Politique QHSE', bg: '#f0f0fa', c: '#000080' },
